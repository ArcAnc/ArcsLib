...
public class PChestTestArmor extends PEntityRenderLayer<TestEntity, PEntityRenderState.LivingImpl<TestEntity>>
{
	public PChestTestArmor()
	{
		super(new DefaultEntityLayerModelData.
						DefaultEntityLayerModelDataBuilder(Registration.EntityTypeReg.TEST_ENTITY.getId(), PLibDatabase.rl("armor_chest")).
							build(),
