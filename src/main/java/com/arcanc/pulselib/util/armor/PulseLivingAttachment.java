...
public class PulseLivingAttachment
{
	...
	{
		this(anchor, pulseBone, PRenderTypes.RenderTypeProvider :: trianglesSolid);
	}

	public PulseLivingAttachment(PulseAttachmentAnchor anchor, String pulseBone, Function<Identifier, RenderType> renderType)
	{
	...
	{
		this(anchor, pulseBone, PRenderTypes.RenderTypeProvider :: trianglesSolid, color);
	}

	public PulseLivingAttachment(PulseAttachmentAnchor anchor, String pulseBone, Function<Identifier, RenderType> renderType, int color)
	{
	...
	public static class Builder<T extends Builder<T>>
	{
		...
		protected Function<Identifier, RenderType> renderType = PRenderTypes.RenderTypeProvider :: trianglesSolid;
		...
		public T renderType(Function<Identifier, RenderType> renderType)
		{
			this.renderType = Objects.requireNonNull(renderType);
			return self();
		}
