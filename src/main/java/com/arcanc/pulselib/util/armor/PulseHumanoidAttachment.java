...
public class PulseHumanoidAttachment extends PulseLivingAttachment
{
	...
	public PulseHumanoidAttachment(PulseAttachmentAnchor anchor, String pulseBone, Function<Identifier, RenderType> renderType)
	{
	...
	public PulseHumanoidAttachment(PulseAttachmentAnchor anchor, String pulseBone, Function<Identifier, RenderType> renderType, int color)
	{
