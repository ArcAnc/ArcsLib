...
public abstract class ArcItemRenderer<T extends Item & ArcAnimatable<T>, RS extends ArcItemRenderState<T>> implements SpecialModelRenderer<RS>, ArcRenderer<T, RS>
{
	...
	private void ensureInitialized()
	{
		...
		this.guiProjectionMatrixBuffer = new ProjectionMatrixBuffer("arc_gui_items");
	                   ...
	                   int outlineColor)
	{
		...
		renderState.extractAdditionalData(type, lightCoords, overlayCoords, hasFoil, outlineColor);
